...
public class ExportRegionAdapter {
    final static Logger logger = LogManager.getLogger(ExportRegionAdapter.class);
    static Gson gson = new GsonBuilder().serializeNulls().create();

    public static String ExportRegion(mdlRegion param1, mdlExportParam param2, int port, String db_name){
        String sql = "";
        ...
        try {
            ...
            String[] columns = {"ID Wilayah", "Nama Wilayah"};

            Sheet sheet = workbook.createSheet("Wilayah");
            ...
            int rowNum = 1;
            for(mdlRegion _mdlRegion : mdlRegionList){
                Row row = sheet.createRow(rowNum++);

                row.createCell(0).setCellValue(_mdlRegion.region_id);
                row.createCell(1).setCellValue(_mdlRegion.region_name);
            }
            ...
            try {
                ...
                String fileName = "Wilayah_" + DateHelper.GetDateTimeNowCustomFormat("yyyyMMddHHmmss");
                String url = new String(paramFileUrl+ param2.app_name + "/Region/" + fileName + ".xlsx");
                File createFile = new File(paramFilePath+ param2.app_name + "/Region");
                createFile.mkdirs();
    ...
    public static String ExportRegionTemplate(mdlRegion param1, mdlExportParam param2, int port, String db_name) {
        long startTime = System.currentTimeMillis();
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        String sql = "";
        String urlLink = "";
        ...
        try {
            ...
            for (int i = 0; i < 1; i++) {
                ...
                row.createCell(1).setCellValue("Contoh (GSM1)");
            }
            ...
            try {
                ...
                String fileName = "Wilayah_" + DateHelper.GetDateTimeNowCustomFormat("yyyyMMddHHmmss");
                String url = paramFileUrl + param2.app_name + "/Region/" + fileName + ".xlsx";
                File createFile = new File(paramFilePath + param2.app_name + "/Region");
                createFile.mkdirs();
