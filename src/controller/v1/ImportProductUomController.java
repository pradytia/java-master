...
import adapter.ImportProductUomAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportProductUomController {
    final static Logger logger = LogManager.getLogger(ImportProductUomController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-product-uom", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody mdlResultFinal ImportExcelProductUom(
        ...
        try {
            ...
            mdlProductUom paramResult = gson.fromJson(param, mdlProductUom.class);
            ...
            if(_mdlResultFinal.status_code.equals("ERR-00-000")){
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result = ImportProductUomAdapter.ImportExcelProductUom(workbook, paramResult, db_name, port);
