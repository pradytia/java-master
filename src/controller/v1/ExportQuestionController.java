...
@RestController
@RequestMapping("/v1")
public class ExportQuestionController {
    final static Logger logger = LogManager.getLogger(ExportQuestionController.class);
    ...
    public @ResponseBody
    mdlResultFinal ExportExcelQuestion(
...
//            db_name = "db_ffa"; //only-testing
                ...
                urlLink = ExportQuestionAdapter.ExportQuestion(paramResult1, paramResult2, port, db_name);
    ...
    @RequestMapping(value = "/export-question-template", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal ExportExcelCostTemplate(
        ...
        String urlLink = "";
        String url = "/export-question-template";
        ...
        try {
            port = request.getLocalPort();
            mdlQuestion paramResult1 = gson.fromJson(param, mdlQuestion.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                urlLink = ExportQuestionAdapter.ExportQuestionTemplate(paramResult1, paramResult2, port, db_name);
                if (!urlLink.equals("")) {
                    _mdlErrorSchema.error_code = "ERR-00-000";
                    _mdlResultFinal = ErrorSchemaAdapter.GetErrorSchema_V2(_mdlErrorSchema, port);
                    _mdlResultFinal.value = urlLink;
