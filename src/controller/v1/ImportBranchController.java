...
import adapter.ImportBranchAdapter;
...
public class ImportBranchController {
    final static Logger logger = LogManager.getLogger(ImportBranchController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-branch", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelBranch(
        ...
        try {
            mdlBranch paramResult_mdlBranch = gson.fromJson(param, mdlBranch.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equalsIgnoreCase("xlsx") || extension.equalsIgnoreCase("xls")) {
                        ...
                        mdlResponseQuery result = ImportBranchAdapter.ImportExcelBranch(workbook, paramResult_mdlBranch, db_name, port);
