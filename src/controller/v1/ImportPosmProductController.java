...
import adapter.ImportPosmProductAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportPosmProductController {
    final static Logger logger = LogManager.getLogger(ImportPosmProductController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-posm-product", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelPosmProduct(
        ...
        String url = "/import-posm-product";
        ...
        try {
            mdlPOSMProduct paramResult = gson.fromJson(param, mdlPOSMProduct.class);
            ...
            if(_mdlResultFinal.status_code.equals("ERR-00-000")){
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result =  ImportPosmProductAdapter.ImportExcelPosmProduct(workbook, paramResult, db_name, port);
