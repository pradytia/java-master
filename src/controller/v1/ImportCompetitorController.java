...
import adapter.ImportCompetitorAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportCompetitorController {
    final static Logger logger = LogManager.getLogger(ImportCompetitorController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0 ;

    @RequestMapping(value = "/import-competitor", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelCompetitor(
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equals("xlsx") || extension.equals("xls")) {
                        ...
                        mdlResponseQuery result = ImportCompetitorAdapter.ImportExcelCompetitor(workbook, paramResult, db_name, port);
                        if (result.Status) {
