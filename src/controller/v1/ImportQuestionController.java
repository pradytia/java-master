...
import adapter.ImportQuestionAdapter;
...
public class ImportQuestionController {
    final static Logger logger = LogManager.getLogger(ImportQuestionController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-question", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelQuestion(
        ...
        try {
            ...
            mdlQuestion paramResult = gson.fromJson(param, mdlQuestion.class);
...
//            db_name = "db_ffa"; //only-testing
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result =  ImportQuestionAdapter.ImportExcelQuestion(workbook, paramResult, db_name,port);
