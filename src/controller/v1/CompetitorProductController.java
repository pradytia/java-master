...
import adapter.CompetitorProductAdapter;
...
public class CompetitorProductController {
    final static Logger logger = LogManager.getLogger(CompetitorProductController.class);
    static Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/upload-competitor-product", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal UploadCompetitorProductWeb(
        ...
        String url = "/upload-competitor-product";
        ...
        //TODO 1 (UploadCompetitorProductWeb) : Param untuk InsertLogApi
        String lException = "";
        String is_error = "";
        try {
            Type listType = new TypeToken<List<mdlCompetitorProduct>>() {
            }.getType();
            List<mdlCompetitorProduct> _mdlCompetitorProductList = gson.fromJson(param, listType);
...
//                db_name = "db_ffa"; //only-testing
                ...
                boolean result = CompetitorProductAdapter.UploadCompetitorProductWeb(_mdlCompetitorProductList, db_name, port);
                if (result) {
            ...
            // TODO 3 (UploadCompetitorProductWeb) : Set Data exception untuk InsertLogApi
        ...
        if(is_error.equals("1")  || mdlLogApiConfig.is_active == true) {
            //TODO 5 (UploadCompetitorProductWeb) : Input data ke model.Log.mdlInsertLog modelInsertLogParam
            model.Log.mdlInsertLog modelInsertLogParam = new model.Log.mdlInsertLog();
            modelInsertLogParam.api_name = url;
            modelInsertLogParam.fuction_name = "UploadCompetitorProductWeb";
            ...
            //TODO 6 (Upload Competitor Product Web) : Input data yang telah diisi ke core.LogAdapter.InsertLog
