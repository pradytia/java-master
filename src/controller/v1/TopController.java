...
public class TopController {
    ...
    final static Logger logger = LogManager.getLogger(TopController.class);
    ...
    mdlResultFinal UploadTop (
        ...
        try {
            ...
            mdlTop paramResult;
            paramResult = gson.fromJson(param, mdlTop.class);
...
//                db_name = "db_ffa"; //only-testing
                ...
                boolean result = adapter.TopAdapter.UploadTop(paramResult, db_name, port);
            ...
            // TODO 3 (UploadTop) : Set Data exception untuk InsertLogApi
...
//            return _mdlResultFinal;
        ...
        if(is_error.equals("1")  || mdlLogApiConfig.is_active == true) {
            ...
            //TODO 6 (UploadTop) : Input data yang telah diisi ke core.LogAdapter.InsertLog
    ...
    //GetTopList
    @RequestMapping(value = "/get-top-list", method = RequestMethod.POST)
    public @ResponseBody
...
//            db_name = "db_ffa"; //only-testing
                ...
                int _mdlTopTotalList = TopAdapter.GetTopList(paramResult, db_name, port);
                List<mdlTop> _mdlTopList = TopAdapter.GetTopWeb(paramResult, db_name, port);

                mdlDataTableResult _mdlDataTableResult = new mdlDataTableResult();
                _mdlDataTableResult.records_total = _mdlTopTotalList;
                _mdlDataTableResult.records_filtered = _mdlTopTotalList;
                _mdlDataTableResult.draw = paramResult.draw + 1;
                _mdlDataTableResult.data = _mdlTopList;
    ...
    //Delete Top
    @RequestMapping( value = "/delete-top", method = RequestMethod.POST)
    public @ResponseBody mdlResultFinal DeleteTop (
            HttpServletRequest request,
            HttpServletResponse response,
            @RequestHeader String authorization,
            @RequestHeader String key,
...
//                db_name = "db_ffa"; //only-testing
                ...
                boolean result = adapter.TopAdapter.DeleteTop(paramResult, db_name, port);
