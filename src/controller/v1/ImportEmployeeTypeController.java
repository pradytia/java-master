...
import adapter.ImportEmployeeTypeAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportEmployeeTypeController {
    final static Logger logger = LogManager.getLogger(ImportEmployeeTypeController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-employee-type", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelEmployeeType(
        ...
        String url = "/import-employee-type";
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equalsIgnoreCase("xlsx") || extension.equalsIgnoreCase("xls")) {
                        ...
                        mdlResponseQuery result = ImportEmployeeTypeAdapter.ImportExcelEmployeeType(workbook, paramResult, db_name, port);
