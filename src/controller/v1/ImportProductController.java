...
import adapter.ImportProductAdapter;
...
public class ImportProductController {
    final static Logger logger = LogManager.getLogger(ImportProductController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-product", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody mdlResultFinal ImportExcelProduct(
        ...
        try {
            ...
            mdlProduct paramResult = gson.fromJson(param, mdlProduct.class);
...
//                db_name = "db_grc0"; //only-testing
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result = ImportProductAdapter.ImportExcelProduct(workbook, paramResult, db_name, port);
