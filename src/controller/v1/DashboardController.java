...
import model.Dashboard.mdlDashboardGlobal;
import model.Dashboard.mdlDashboardParam;
...
public class DashboardController {
    ...
    mdlResultFinal GetDashboard(
        ...
        try {
            mdlDashboardParam paramResult = gson.fromJson(param, mdlDashboardParam.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                mdlDashboardGlobal _mdlDashboardGlobal = DashboardAdapter.GetDashboard(paramResult, db_name, port);
                if (_mdlDashboardGlobal != null) {
                    _mdlErrorSchema.error_code = "ERR-00-000";
                    _mdlResultFinal = ErrorSchemaAdapter.GetErrorSchema_V2(_mdlErrorSchema, port);
                    _mdlResultFinal.value = _mdlDashboardGlobal;
                } else {
