...
import adapter.ImportCustomerTypeAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportCustomerTypeController {
    final static Logger logger = LogManager.getLogger(ImportCustomerTypeController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0 ;

    @RequestMapping(value = "/import-customer-type", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelCustomerType(
        ...
        String url = "/import-customer-type";
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equalsIgnoreCase("xlsx") || extension.equalsIgnoreCase("xls")) {
                        ...
                        mdlResponseQuery result = ImportCustomerTypeAdapter.ImportExcelCustomerType(workbook, paramResult, db_name, port);
