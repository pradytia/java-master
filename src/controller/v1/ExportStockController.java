...
import adapter.ExportStockAdapter;
...
public class ExportStockController {
    ...
    @RequestMapping(value = "/export-stock-template", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal ExportExcelStockTemplate(
        ...
        String urlLink = "";
        String url = "/export-stock-template";
        ...
        try {
            port = request.getLocalPort();
            mdlStock paramResult1 = gson.fromJson(param, mdlStock.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                urlLink = ExportStockAdapter.ExportStockTemplate(paramResult1, paramResult2, port,  db_name);
                if (!urlLink.equals("")) {
