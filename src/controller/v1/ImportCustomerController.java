...
import adapter.ImportCustomerAdapter;
...
public class ImportCustomerController {
    final static Logger logger = LogManager.getLogger(ImportCustomerController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-customer", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
...
//                db_name = "db_grc0"; //only-testing
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equalsIgnoreCase("xlsx")) {
                        ...
                        mdlResponseQuery result = ImportCustomerAdapter.ImportExcelCustomer(workbook, paramResult, db_name, port);
