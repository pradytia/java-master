...
@RestController
@RequestMapping("/v1")
public class ImportCustomerInfoController {
    final static Logger logger = LogManager.getLogger(ImportCustomerInfoController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-customer-info", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal importExcelCustomer(
        ...
        String url = "/import-customer-info";
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equalsIgnoreCase("xlsx") || extension.equalsIgnoreCase("xls")) {
                        ...
                        mdlResponseQuery result = adapter.CustomerInfoAdapter.ImportExcelCustomer(workbook, paramResult, db_name, port);
