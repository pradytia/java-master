...
import adapter.ExportRegionAdapter;
...
public class ExportRegionController {
    ...
    @RequestMapping(value = "/export-region", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal ExportExcelRegion(
        ...
        String url = "/export-region";

        mdlRegion paramResult1;
        paramResult1 = gson.fromJson(param, mdlRegion.class);
...
//            db_name = "db_ffa"; //only-testing
            ...
            urlLink = ExportRegionAdapter.ExportRegion(paramResult1, paramResult2, port, db_name);
    ...
    @RequestMapping(value = "/export-region-template", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal ExportExcelRegionTemplate(
            @RequestHeader String authorization,
            @RequestHeader String key,
            @RequestHeader String timestamp,
            @RequestHeader String signature,
        ...
        String urlLink = "";
        String url = "/export-region-template";
        ...
        try {
            port = request.getLocalPort();
            mdlRegion paramResult1 = gson.fromJson(param, mdlRegion.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                urlLink = ExportRegionAdapter.ExportRegionTemplate(paramResult1, paramResult2, port,  db_name);
                if (!urlLink.equals("")) {
                    _mdlErrorSchema.error_code = "ERR-00-000";
                    _mdlResultFinal = ErrorSchemaAdapter.GetErrorSchema_V2(_mdlErrorSchema, port);
                    _mdlResultFinal.value = urlLink;
