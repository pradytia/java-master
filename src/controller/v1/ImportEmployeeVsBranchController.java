...
import adapter.ImportEmployeeVsBranchAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportEmployeeVsBranchController {
    final static Logger logger = LogManager.getLogger(ImportEmployeeVsBranchController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-employee-vs-branch", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelEmployeeVsBranch(
        ...
        String url = "/import-employee-vs-branch";
        ...
        try {
            mdlEmployeeVsBranch paramResult = gson.fromJson(param, mdlEmployeeVsBranch.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equalsIgnoreCase("xlsx") || extension.equalsIgnoreCase("xls")) {
                        ...
                        mdlResponseQuery result = ImportEmployeeVsBranchAdapter.ImportExcelEmployeeVsBranch(workbook, paramResult, db_name, port);
