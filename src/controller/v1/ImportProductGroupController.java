...
import adapter.ImportProductGroupAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportProductGroupController {
    final static Logger logger = LogManager.getLogger(ImportProductGroupController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-product-group", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody mdlResultFinal ImportExcelProductGroup(
        ...
        String url = "/import-product-group";
        ...
        try {
            ...
            mdlProductGroup paramResult = gson.fromJson(param, mdlProductGroup.class);
            ...
            if(_mdlResultFinal.status_code.equals("ERR-00-000")){
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result =  ImportProductGroupAdapter.ImportExcelProductGroup(workbook, paramResult, db_name, port);
