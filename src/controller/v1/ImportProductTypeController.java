...
import adapter.ImportProductTypeAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportProductTypeController {
    final static Logger logger = LogManager.getLogger(ImportProductTypeController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-product-type", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody mdlResultFinal ImportExcelProductType(
        ...
        String url = "/import-product-type";
        ...
        try {
            mdlProductType paramResult = gson.fromJson(param, mdlProductType.class);
            ...
            if(_mdlResultFinal.status_code.equals("ERR-00-000")){
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result =  ImportProductTypeAdapter.ImportExcelProductType(workbook, paramResult, db_name, port);
