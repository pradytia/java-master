...
import adapter.ExportReasonAdapter;
...
@RestController
@RequestMapping("/v1")
public class ExportReasonController {
    ...
    public @ResponseBody
    mdlResultFinal ExportExcelReason(
        ...
        String url = "/export-reason";

        mdlReason paramResult1;
        paramResult1 = gson.fromJson(param, mdlReason.class);
...
//            db_name = "db_ffa"; //only-testing
                ...
                urlLink = ExportReasonAdapter.ExportReason(paramResult1, paramResult2, port, db_name);
    ...
    @RequestMapping(value = "/export-reason-template", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal ExportExcelReasonTemplate(
            @RequestHeader String authorization,
            @RequestHeader String key,
            @RequestHeader String timestamp,
            @RequestHeader String signature,
        ...
        String urlLink = "";
        String url = "/export-reason-template";
        String apiMethod = request.getMethod();
        // get all headers for logging purpose
        Map<String, String> headerList = Collections.list(request.getHeaderNames()).stream().collect(Collectors.toMap(h -> h, request::getHeader));
        String jsonHeader = gson.toJson(headerList);
        ...
        try {
            port = request.getLocalPort();
            mdlReason paramResult1 = gson.fromJson(param, mdlReason.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                urlLink = ExportReasonAdapter.ExportReasonTemplate(paramResult1, paramResult2, port,  db_name);
                if (!urlLink.equals("")) {
                    _mdlErrorSchema.error_code = "ERR-00-000";
                    _mdlResultFinal = ErrorSchemaAdapter.GetErrorSchema_V2(_mdlErrorSchema, port);
                    _mdlResultFinal.value = urlLink;
