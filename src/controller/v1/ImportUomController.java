...
import adapter.ImportUomAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportUomController {
    final static Logger logger = LogManager.getLogger(ImportUomController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-uom", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody mdlResultFinal ImportExcelUom(
        ...
        try {
            ...
            mdlUom paramResult = gson.fromJson(param, mdlUom.class);
            ...
            if(_mdlResultFinal.status_code.equals("ERR-00-000")){
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result =  ImportUomAdapter.ImportExcelUom(workbook, paramResult, db_name, port);
