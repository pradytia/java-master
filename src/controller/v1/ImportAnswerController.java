...
import adapter.ImportAnswerAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportAnswerController {
    final static Logger logger = LogManager.getLogger(ImportAnswerController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-answer", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelAnswer(
...
//            db_name = "db_ffa"; //only-testing
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equals("xlsx")) {
                        ...
                        mdlResponseQuery result = ImportAnswerAdapter.ImportExcelAnswer(workbook, paramResult, db_name, port);
