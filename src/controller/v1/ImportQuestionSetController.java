...
import adapter.ImportQuestionSetAdapter;
...
@RestController
@RequestMapping("/v1")
public class ImportQuestionSetController {
    final static Logger logger = LogManager.getLogger(ImportQuestionSetController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-question-set", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal ImportExcelQuestionSet(
        ...
        String url = "/import-question-set";
        ...
        try {
            ...
            mdlQuestionSet paramResult = gson.fromJson(param, mdlQuestionSet.class);
...
//            db_name = "db_ffa"; //only-testing
                ...
                if(excelfile != null && !excelfile.isEmpty()){
                    ...
                    if(extension.equals("xlsx")){
                        ...
                        mdlResponseQuery result =  ImportQuestionSetAdapter.ImportExcelQuestionSet(workbook, paramResult, db_name, port);
