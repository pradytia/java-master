...
@RestController
@RequestMapping("/v1")
public class ImportCustomerNPWPController {
    final static Logger logger = LogManager.getLogger(ImportCustomerNPWPController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/import-customer-NPWP", method = RequestMethod.POST, consumes = "multipart/form-data")
    public @ResponseBody
    mdlResultFinal importExcelCustomer(
        ...
        String url = "/import-customer-NPWP";
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                if (excelfile != null && !excelfile.isEmpty()) {
                    ...
                    if (extension.equalsIgnoreCase("xlsx") || extension.equalsIgnoreCase("xls")) {
                        ...
                        mdlResponseQuery result = adapter.CustomerNPWPAdapter.ImportExcelCustomer(workbook, paramResult, db_name, port);
                        if (result.Status) {
