...
@RestController
@RequestMapping("/v1")
public class ExportUomController {
    final static Logger logger = LogManager.getLogger(ExportCallPlanController.class);
    Gson gson = new GsonBuilder().serializeNulls().create();
    String db_name = "";
    int port = 0;

    @RequestMapping(value = "/export-uom", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal ExportExcelUom(
        ...
        String url = "/export-uom";

        mdlUom paramResult1;
        paramResult1 = gson.fromJson(param, mdlUom.class);
...
//            db_name = "db_ffa"; //only-testing
            ...
            urlLink = ExportUomAdapter.ExportUom(paramResult1, paramResult2, port, db_name);
    ...
    @RequestMapping(value = "/export-uom-template", method = RequestMethod.POST)
    public @ResponseBody
    mdlResultFinal ExportExcelUomTemplate(
            @RequestHeader String authorization,
            @RequestHeader String key,
            @RequestHeader String timestamp,
            @RequestHeader String signature,
        ...
        String urlLink = "";
        String url = "/export-uom-template";
        ...
        try {
            port = request.getLocalPort();
            mdlUom paramResult1 = gson.fromJson(param, mdlUom.class);
            ...
            if (_mdlResultFinal.status_code.equals("ERR-00-000")) {
                ...
                urlLink = ExportUomAdapter.ExportUomTemplate(paramResult1, paramResult2, port,  db_name);
                if (!urlLink.equals("")) {
                    _mdlErrorSchema.error_code = "ERR-00-000";
                    _mdlResultFinal = ErrorSchemaAdapter.GetErrorSchema_V2(_mdlErrorSchema, port);
                    _mdlResultFinal.value = urlLink;
